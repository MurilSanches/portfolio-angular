...
@Component({
  ...
  standalone: true,
  template: `
    <footer class="border-t border-black/5 py-10 dark:border-white/10">
      <div class="mx-auto max-w-6xl px-4">
        <div class="flex flex-col items-center gap-6 md:flex-row md:justify-between">

          <div class="text-center md:text-left">
            <p class="text-sm font-semibold">Murilo Sanches</p>
            <p class="mt-1 text-xs opacity-30">☣ Themed after Resident Evil</p>
          </div>
          ...
          <p class="text-sm opacity-40">© {{ year() }}</p>
